...
@section('contenido2')
    <div class="container">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-8">
                <input type="text" class="form-control" name="nombredepto" id="nombredepto" placeholder="Nombre del depto"
                    value="{{ @old('nombredepto', $depto->nombredepto) }} " {{ $des }} />
                @error('nombredepto')
                    <p>Error en el nombre del depto: {{ $message }}</p>
                @enderror
            </div>
        </div>
        <div class="mb-3 row">
            ...
            <div class="col-8">
                <input type="text" class="form-control" name="nombremediano" id="nombremediano" placeholder="Apellido paterno"
                    value="{{ @old('nombremediano', $depto->nombremediano) }} " {{ $des }} />
                @error('nombremediano')
        ...
        <div class="mb-3 row">
            ...
            <div class="col-8">
                <input type="text" class="form-control" name="nombrecorto" id="nombrecorto" placeholder="Nombre corto"
                    value="{{ @old('nombrecorto', $depto->nombrecorto) }} " {{ $des }} />
                @error('tipo')
